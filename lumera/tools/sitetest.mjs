...
for (const [tag, vp] of [["desk",{width:1440,height:900}],["mob",{width:390,height:844}]]) {
  ...
  out.push(((await p.evaluate(() => document.querySelectorAll(".sh .mark svg.lg path").length === 6 && document.querySelectorAll(".sh .mark svg.sy path").length === 1 && document.querySelectorAll("#intro svg.sy path").length === 1 && document.querySelectorAll("#end svg.sy.huge").length === 1)) ? "PASS":"FAIL") + ` ${tag} symbol, lockup, intro trace, footer symbol`);
