...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      ...
      { property: "og:image", content: "https://silavu-house.higgsfield.app/og.jpg?v=3" },
      ...
      { name: "twitter:image", content: "https://silavu-house.higgsfield.app/og.jpg?v=3" },
    ],
    links: [
      { rel: "icon", href: "/favicon.ico?v=3", sizes: "48x48 32x32 16x16" },
      { rel: "icon", href: "/icon-32.png?v=3", type: "image/png", sizes: "32x32" },
      { rel: "icon", href: "/icon-16.png?v=3", type: "image/png", sizes: "16x16" },
      { rel: "icon", href: "/favicon.svg?v=3", type: "image/svg+xml", sizes: "any" },
      { rel: "apple-touch-icon", href: "/icon-180.png?v=3", sizes: "180x180" },
